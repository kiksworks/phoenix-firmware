...
# Memory: data_ram_0
MEM_0 := controller_data_ram_0
$(MEM_0)_NAME := data_ram_0
...
$(MEM_0)_HIERARCHICAL_PATH := data_ram_0
$(MEM_0)_WIDTH := 32
...
.PHONY: data_ram_0
data_ram_0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: data_ram_1
MEM_1 := controller_data_ram_1
$(MEM_1)_NAME := data_ram_1
...
$(MEM_1)_START := 0x0000b000
$(MEM_1)_END := 0x0000b3ff
$(MEM_1)_SPAN := 0x00000400
$(MEM_1)_HIERARCHICAL_PATH := data_ram_1
$(MEM_1)_WIDTH := 32
...
.PHONY: data_ram_1
data_ram_1: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

# Memory: instruction_rom_0
MEM_2 := controller_instruction_rom_0
$(MEM_2)_NAME := instruction_rom_0
...
$(MEM_2)_HIERARCHICAL_PATH := instruction_rom_0
$(MEM_2)_WIDTH := 32
$(MEM_2)_HEX_DATA_WIDTH := 32
$(MEM_2)_ENDIANNESS := --little-endian-mem
$(MEM_2)_CREATE_LANES := 0

.PHONY: instruction_rom_0
instruction_rom_0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
